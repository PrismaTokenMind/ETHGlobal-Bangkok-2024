...
def cow_trade_limit(wallet: Wallet, amount_from: str, amount_to: str, from_asset_id: str, to_asset_id: str, order_duration: str) -> str:
    ...
    return f"Submitted the limit order with id {order_id} to solvers.\nYou can view the trade at https://explorer.cow.fi/arb1/orders/{order_id}?tab=overview Trade {sell_amount} of {from_asset_id} for {buy_amount} of {to_asset_id}.\n"
